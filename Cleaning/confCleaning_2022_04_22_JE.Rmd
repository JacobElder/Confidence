...
```{r}
rawDf$remove <- ifelse(rawDf$Usable == 2 | rawDf$UnderstandTr < 4 | rawDf$UnderstandIns < 4 | rawDf$Serious < 5  | rawDf$ConDeb == 2 | rawDf$Off5 == 3, 1, 0)
...
```{r}
write.csv(longDf,"/Volumes/GoogleDrive/My Drive/Volumes/Research Project/Metacognition/Study 1/input/confClean.csv")
```
